    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <nav aria-label="Page navigation" class="d-flex justify-content-center pagination" >
                ...
                <ul class="pagination-demo" id="pagination-demo"> </ul>
            </nav>
                ...
                <div class="modal-body">
                    <form class="formulario2">
                        ...
                        <div style="padding-top: 1%;">
                            <button class="btn-success btnmodal" type="button" onclick="editar()" data-bs-dismiss="modal">Salvar</button>
                        </div>
                        <div style="padding-top: 1%;">
